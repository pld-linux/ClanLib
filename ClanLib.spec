...
%description -l pt_BR
A Clanlib И uma biblioteca de jogos multi-plataforma desenhada para
facilitar o trabalho dos desenvolvedores. A idИia principal И fornecer
uma interface comum para os problemas clАssicos dos jogos (carregar
grАficos por exemplo).
...
Programistyczne dodatki do ClanLib-a, zawieraj╠ pliki nagЁСwkowe
potrzebne do kompilacji programСw korzystaj╠cych z ClanLib.
...
Summary(pl):	obsЁuga svgalib dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
ObsЁuga svgalib dla ClanLib-a.

%package OpenGL
Summary:	OpenGL target for ClanLib
Summary(pl):	obsЁuga OpenGL dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
ObsЁuga OpenGL dla ClanLib-a.

%package GGI
Summary:	GGI target for ClanLib
Summary(pl):	obsЁuga GGI dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
Summary(pl):	ModuЁ Mikmod dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
ModuЁ Mikmod dla ClanLib-a.

%package Vorbis
Summary:	Vorbis module for ClanLib
Summary(pl):	ModuЁ Vorbis dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
ModuЁ Vorbis dla ClanLib-a.

%package TTF
Summary:	TTF module for ClanLib
Summary(pl):	ModuЁ TTF dla ClanLib
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
